                ...
                <div className="divide-y divide-zinc-50">
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-32 text-center">
                            ...
                            <Button variant="outline" className="mt-8">Abrir Agenda</Button>
                        </div>
                    ) : (
                            ...
                            <div key={app.id} className="group flex items-center p-8 hover:bg-zinc-50/50 transition-all relative">
                                ...
                                <div className="flex items-center gap-10">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button className="w-14 h-14 flex items-center justify-center bg-zinc-50 text-zinc-400 rounded-2xl hover:bg-zinc-100 transition-all border border-zinc-100">
